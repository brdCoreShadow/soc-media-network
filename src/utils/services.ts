export function getIconByPlatform(platform: string) {
  switch (platform) {
    case "fb":
...
export function getColorByPlatform(platform: string) {
  switch (platform) {
    case "fb":
      return "#1877F2";
    case "twitter":
...
export function getColorByDifference(difference: string) {
